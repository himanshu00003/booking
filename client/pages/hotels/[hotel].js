...
export async function getStaticPaths() {
    const response = await axios.get(`https://backend-vr9r.onrender.com/api/hotels`);
...
export async function getStaticProps(context) {
    ...
    const res = await axios.get(`https://backend-vr9r.onrender.com/api/hotel/${params.hotel}`);
    const res2 = await axios.get(`https://backend-vr9r.onrender.com/api/rooms/${params.hotel}`);
