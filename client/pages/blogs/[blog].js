...
export async function getStaticPaths() {
    const response = await axios.get(`https://backend-vr9r.onrender.com/api/blogs`);
...
export async function getStaticProps(context) {
    ...
    console.log(params);
    const res = await axios.get(`https://backend-vr9r.onrender.com/api/blog/${params.blog}`);
